...
namespace Jium.MySQLDAL
{
	...
	/// 数据访问类:currentalarm
	/// </summary>
	public partial class currentalarm:Icurrentalarm
	{
		public currentalarm()
		{}
		#region  BasicMethod
		...
		public DataSet GetList(string strWhere)
		{
			...
			strSql.Append(" FROM currentalarm ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from currentalarm T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "currentalarm";
