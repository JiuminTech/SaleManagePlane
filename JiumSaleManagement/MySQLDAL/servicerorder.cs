	...
	public partial class servicerorder:Iservicerorder
	{
		...
		public bool Add(Jium.Model.servicerorder model)
		{
			...
			MySqlParameter[] parameters = {
					...
					new MySqlParameter("@sos1", MySqlDbType.VarChar,20),
					new MySqlParameter("@sos2", MySqlDbType.VarChar,20),
					new MySqlParameter("@sos3", MySqlDbType.VarChar,20),
					new MySqlParameter("@sos4", MySqlDbType.VarChar,20),
					new MySqlParameter("@sos5", MySqlDbType.VarChar,20),
