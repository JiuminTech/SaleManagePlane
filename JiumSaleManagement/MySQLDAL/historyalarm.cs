...
namespace Jium.MySQLDAL
{
	...
	/// 数据访问类:historyalarm
	/// </summary>
	public partial class historyalarm:Ihistoryalarm
	{
		public historyalarm()
		{}
		#region  BasicMethod
		...
		public bool Exists(long id)
		{
			...
			strSql.Append("select count(1) from historyalarm");
		...
		/// 增加一条数据
		/// </summary>
		public bool Add(Jium.Model.historyalarm model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("insert into historyalarm(");
		...
		/// 更新一条数据
		/// </summary>
		public bool Update(Jium.Model.historyalarm model)
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("update historyalarm set ");
		...
		public bool Delete(long id)
		{
			...
			StringBuilder strSql=new StringBuilder();
			strSql.Append("delete from historyalarm ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int64)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Jium.Model.historyalarm GetModel(long id)
		{
			
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,alarmname,alarmdesc,createtime,updatetime,ownerid,handlerid,alarmtype,operateid,handlestatus,confirmtime,handledetail from historyalarm ");
			strSql.Append(" where id=@id");
			MySqlParameter[] parameters = {
					new MySqlParameter("@id", MySqlDbType.Int64)
			};
		...
		/// 得到一个对象实体
		/// </summary>
		public Jium.Model.historyalarm DataRowToModel(DataRow row)
		{
			Jium.Model.historyalarm model=new Jium.Model.historyalarm();
			if (row != null)
			{
		...
		{
			StringBuilder strSql=new StringBuilder();
			strSql.Append("select id,alarmname,alarmdesc,createtime,updatetime,ownerid,handlerid,alarmtype,operateid,handlestatus,confirmtime,handledetail ");
			strSql.Append(" FROM historyalarm ");
			if(strWhere.Trim()!="")
			{
		...
		public DataSet GetListByPage(string strWhere, string orderby, int startIndex, int endIndex)
		{
			...
			strSql.Append(")AS Row, T.*  from historyalarm T ");
		...
		public DataSet GetList(int PageSize,int PageIndex,string strWhere)
		{
			...
			parameters[0].Value = "historyalarm";
