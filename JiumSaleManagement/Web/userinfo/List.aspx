<%@ Page Title="userinfo" Language="C#" MasterPageFile="~/MasterPage.master" AutoEventWireup="true" CodeBehind="List.aspx.cs" Inherits="Jium.Web.userinfo.List" %>
...
<!--Title -->
		...
		<asp:BoundField DataField="token" HeaderText="token" SortExpression="token" ItemStyle-HorizontalAlign="Center"  /> 
		<asp:BoundField DataField="tokentime" HeaderText="tokentime" SortExpression="tokentime" ItemStyle-HorizontalAlign="Center"  /> 
